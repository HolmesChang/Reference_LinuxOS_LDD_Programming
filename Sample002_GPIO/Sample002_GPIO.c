...
MODULE_DESCRIPTION("Simple002_GPIO");
...
static int __init Sample002_GPIO_Init (void) {
	pr_info("Begin\n");
		
	pr_info("GPIO Initialization\n");
...
static void __exit Sample002_GPIO_Exit (void) {
	pr_info("Begin\n");
...
module_init(Sample002_GPIO_Init);
module_exit(Sample002_GPIO_Exit);
